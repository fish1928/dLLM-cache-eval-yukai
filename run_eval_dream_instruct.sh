...
run_dream_task minerva_math   4   256  0.2   bos    "prompt_interval_steps=50,gen_interval_steps=1,cfg_interval_steps=1"
run_dream_task bbh            3   256  0.2   alg    "prompt_interval_steps=10,gen_interval_steps=2,cfg_interval_steps=1"
run_dream_task mbpp           3   256  0.2   alg    "prompt_interval_steps=10,gen_interval_steps=8,cfg_interval_steps=1"   --confirm_run_unsafe_code
run_dream_task humaneval      0   256  0.2   alg    "prompt_interval_steps=50,gen_interval_steps=1,cfg_interval_steps=1"   --confirm_run_unsafe_code
