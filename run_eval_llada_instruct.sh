...
run_llada_task truthfulqa_gen 0   "block_length=256,gen_length=256,steps=256,cfg_scale=0.0"             "prompt_interval_steps=50,gen_interval_steps=6,cfg_interval_steps=1" -     --apply_chat_template
