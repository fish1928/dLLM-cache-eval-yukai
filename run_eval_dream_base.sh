...
run_dream_task minerva_math   4   512  0.2   bos    "prompt_interval_steps=100,gen_interval_steps=4,cfg_interval_steps=1"
run_dream_task bbh            3   256  0.2   alg    "prompt_interval_steps=25,gen_interval_steps=4,cfg_interval_steps=1"
run_dream_task mbpp           3   512  0.2   alg    "prompt_interval_steps=25,gen_interval_steps=8,cfg_interval_steps=1"  --confirm_run_unsafe_code
run_dream_task humaneval      0   512  0.2   alg    "prompt_interval_steps=5,gen_interval_steps=1,cfg_interval_steps=1"   --confirm_run_unsafe_code
