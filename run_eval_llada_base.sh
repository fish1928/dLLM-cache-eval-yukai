...
run_llada_task gsm8k          4   "block_length=256,gen_length=256,steps=256,cfg_scale=0"               "prompt_interval_steps=100,gen_interval_steps=6"               -
run_llada_task minerva_math   4   "block_length=256,gen_length=256,steps=256,cfg_scale=0.0"             "prompt_interval_steps=50,gen_interval_steps=8,cfg_interval_steps=1" -
...
run_llada_task mbpp           3   "block_length=32,gen_length=256,steps=256,cfg_scale=0.0,remasking=low_confidence" "prompt_interval_steps=50,gen_interval_steps=4"    -           --confirm_run_unsafe_code
run_llada_task humaneval      0   "block_length=256,gen_length=256,steps=256,cfg_scale=0.0"             "prompt_interval_steps=50,gen_interval_steps=5"                add_bos_token=True --confirm_run_unsafe_code
