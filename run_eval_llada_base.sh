...
run_llada_task mbpp           3   "block_length=32,gen_length=512,steps=512,cfg_scale=0.0,remasking=low_confidence" "prompt_interval_steps=50,gen_interval_steps=4"    -           --confirm_run_unsafe_code
run_llada_task humaneval      0   "block_length=512,gen_length=512,steps=512,cfg_scale=0.0"             "prompt_interval_steps=50,gen_interval_steps=5"                add_bos_token=True --confirm_run_unsafe_code
